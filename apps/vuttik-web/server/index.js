...
import { authenticateToken, optionalAuth, requireRole, requireMegaGuardian, requireSelf, requireBusinessAccess, userCanActForBusiness, resolveActingUid, invalidateUser, globalLimiter, aiLimiter, } from './middleware.js';
...
if (process.env.NODE_ENV === 'production') {
    ...
    if (missing.length) {
        console.error(`FATAL: ${missing.join(', ')} must be set to a value of at least 32 characters in production.`);
        process.exit(1);
    }
}
