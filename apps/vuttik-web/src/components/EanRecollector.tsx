...
import EanBulkUploadModal from './EanBulkUploadModal';
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mb-8">
        ...
        {isAdminOrGuardian && (
          <button
            ...
            className="w-full md:w-auto flex items-center justify-center gap-2 bg-white text-vuttik-blue border border-vuttik-blue/20 px-6 py-4 rounded-2xl font-bold hover:bg-blue-50 transition-colors shadow-sm"
          >
            <Upload size={20} />
            Subir Archivo
          </button>
