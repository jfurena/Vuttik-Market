                ...
                {visibleCategories.map((cat, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                          <h3 className="text-xl font-display font-black text-gray-900 group-hover:text-vuttik-blue transition-colors">
                            {cat.name.split(/\s+/).map(w => w.charAt(0).toUpperCase() + w.slice(1).toLowerCase()).join(' ')}
                          </h3>
              ...
              {visibleCount < filteredCategories.length && (
                <div className="flex justify-center mt-8 mb-4 w-full">
                  <button 
                    ...
                    className="px-8 py-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 text-vuttik-navy font-bold rounded-xl transition-colors text-sm flex items-center gap-2"
                  >
                    Ver Más Categorías
                  </button>
                </div>
