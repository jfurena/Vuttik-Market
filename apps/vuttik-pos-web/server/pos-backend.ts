...
function imagenesJson(prod: any): string {
  const ruta = prod?.imagen;
  if (typeof ruta !== 'string' || !ruta.trim()) return '[]';
...
function ofertaVigente(prod: any): boolean {
...
function precioOferta(prod: any): number | null {
