...
const EMPTY_FORM: EmployeeForm = { nombre: '', username: '', password: '', rol: 'cajero', permisos: [] };

const AVAILABLE_PERMISSIONS = [
  { id: 'manage_employees', label: 'Gestionar Empleados' },
  { id: 'view_finances', label: 'Ver Contabilidad y Ganancias' },
  { id: 'view_audit', label: 'Ver Historial / Auditoría' },
  { id: 'view_history', label: 'Ver Histórico de Ventas' }
];
...
export default function EmployeeManager() {
  ...
  const openEdit = (emp: Employee) => { setEditing(emp); setForm({ nombre: emp.nombre, username: emp.username, password: '', rol: emp.rol, permisos: emp.permisos || [] }); setShowPassword(false); setError(''); setShowForm(true); };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editing) {
        const updateData: any = { nombre: form.nombre, username: form.username, rol: form.rol, permisos: form.permisos };
