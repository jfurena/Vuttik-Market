      ...
      >
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex bg-slate-100/80 p-1 rounded-xl mb-8">
            {([['employee', 'Empleado'], ['register', 'Registrarme'], ['login', 'Entrar']] as [Tab, string][]).map(([t, label]) => (
              <button
                key={t}
              ...
              <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 max-h-96 overflow-y-auto space-y-4 text-xs text-slate-600 leading-relaxed font-medium font-sans">
                {legalDocToShow === 'terms' ? (
                  <>
                    ...
                    <p className="font-bold text-slate-900 text-sm">5. Uso y Transferencia de Datos a Nivel Global</p>
                    <p>
                      Al utilizar Vuttik POS, usted acepta y otorga consentimiento expreso para que los datos operativos, transaccionales y de inventario recopilados sean transferidos y almacenados en la base de datos global de Vuttik Market. Vuttik se reserva el derecho irrevocable de utilizar, analizar, distribuir y procesar esta información para optimizar los servicios, desarrollar nuevas funcionalidades, realizar análisis de mercado y para cualquier otro fin comercial o estratégico. Usted reconoce que los datos agregados transferidos a la base de datos global pasan a ser un activo de Vuttik.
                    </p>
                  </>
                ) : (
                  <>
                    ...
                    <p>
                      Las coordenadas GPS se utilizan única y exclusivamente para auditar que el POS sea operado dentro del perímetro comercial del negocio establecido por el administrador.
                    </p>
                    <p className="font-bold text-slate-900 text-sm">3. Uso y Transferencia de Datos a Nivel Global</p>
                    <p>
                      Al utilizar Vuttik POS, usted acepta y otorga consentimiento expreso para que los datos operativos, transaccionales y de inventario recopilados sean transferidos y almacenados en la base de datos global de Vuttik Market. Vuttik se reserva el derecho irrevocable de utilizar, analizar, distribuir y procesar esta información para optimizar los servicios, desarrollar nuevas funcionalidades, realizar análisis de mercado y para cualquier otro fin comercial o estratégico.
                    </p>
                    <p className="font-bold text-slate-905 text-sm">4. Seguridad de la Información</p>
                    <p>
                      Todos los datos operativos se almacenan de forma local cifrada y se transmiten mediante canales seguros TLS en caso de sincronización en la nube, garantizando altos estándares de confidencialidad.
                    </p>
                    <p className="font-bold text-slate-900 text-sm">5. Derechos del Usuario</p>
                    <p>
                      Como usuario de Vuttik POS, puede solicitar al administrador la consulta, modificación o eliminación de sus registros personales, siempre que no afecten los requisitos de auditoría de transacciones fiscales y contables obligatorias del negocio. Usted reconoce que los datos agregados transferidos a la base de datos global pasan a ser un activo de Vuttik.
                    </p>
                  </>
                )}
              </div>
