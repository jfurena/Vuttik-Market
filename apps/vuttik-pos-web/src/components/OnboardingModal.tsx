    ...
    <div className="fixed inset-0 z-[100] bg-white flex flex-col md:flex-row overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 pt-10">
          ...
          >
            Gestión Total<br/><span className="text-[#38bdf8]">Vuttik POS.</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Para brindarte la mejor experiencia en tu Punto de Venta, necesitamos configurar tu cuenta al instante.
          </motion.p>
        </div>
