...
export const api = {
  ...
  getMegaGuardianDB: (source: string, table: string) => request(`/api/mega-guardian/db/${source}/${table}`),
  updateMegaGuardianDB: (source: string, table: string, id: string, data: any) => request(`/api/mega-guardian/db/${source}/${table}/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data)
  }),
  deleteMegaGuardianDB: (source: string, table: string, id: string) => request(`/api/mega-guardian/db/${source}/${table}/${id}`, {
    method: 'DELETE'
  }),
};
